...
const BabyAndMomCare = () => {
  ...
  // Filter products for Baby & Mom Care category
  const babyAndMomProducts = products.filter(product => 
  ...
  if (babyAndMomProducts.length === 0) {
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        <h2 className="text-2xl font-semibold text-gray-600 mb-2">No Products Available</h2>
        <p className="text-gray-500 mb-4">We currently don't have any products in this category.</p>
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">Baby & Mom Care</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {babyAndMomProducts.map((product) => (
