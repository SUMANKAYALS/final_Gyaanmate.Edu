...
function localBotReply(query, courses) {
  ...
  if (/^(hi|hello|hey|good\s)/.test(q)) {
    return "Hello! I'm LearnHub AI. I can help you discover courses, plan what to learn next, or answer study questions. What would you like to learn?";
  }
  return "I'm LearnHub AI! Ask me about any topic — for example: \"React for beginners\", \"best AI courses\", or \"how do I start coding?\". I'll suggest courses from our catalog.";
}
